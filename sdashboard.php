...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <div class="col-lg-6">
            <h1 class="page-header titlehms"><i class="fa fa-hand-o-right"></i>Student's Dashboard<i class="fa fa-hand-o-left"></i></h1>
            </div>
            <div class="col-lg-6">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <a href="https://nith.ac.in/student-related-notices"><i class="fa fa-list-alt fa-fw"></i>Notice Board</a>
                </div>
