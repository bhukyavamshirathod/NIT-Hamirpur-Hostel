...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <img alt="HMS" class="pull-left" src="<?php echo $base_url.'files/photos/nith.png'?>" height="45" width="45"><span class="auto-style1"><a class="navbar-brand titlehms" href="<?php echo $base_url.'sdashboard.php'?>"><span class="auto-style2"><span lang="en-in">NIT-H 
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <i class="fa fa-bars fa-fw"></i> <span class="auto-style2">Menu 
