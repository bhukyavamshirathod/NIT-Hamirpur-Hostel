...
<body background=url('bg.jpg'); style="background-image: url('NIT-Hamirpur.jpeg')">

 
<div class="container">
    <div class="row">

        <div class="col-md-4 col-md-offset-4" style="left: 0px; top: 0px; width: 472px">

            <div class="login-panel panel panel-default">

                <div class="panel-heading">
                    <div class="row" style="width: 1622px">
                        
                           <a href="https://nith.ac.in/" target="_self">
							<img style="float: left;" src="nithlogo.png" alt="Logo" height="95" width="449" class="auto-style1"></a><br>
                        <div class="col-md-10 col-sm-12 col-xs-10">
                            <h4 class="pTitle"><span lang="en-in">
							<span class="auto-style2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Hostel 
							Management System</span></span></h4>
                            </div>
                    </div>
